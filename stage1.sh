...
packages="base git base-devel linux-hardened linux-hardened-headers linux-hardened-docs dkms linux-firmware btrfs-progs networkmanager neovim sudo iptables zsh man-db"
